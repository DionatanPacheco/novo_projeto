...
class DrawerSuriname extends StatefulWidget {
  const DrawerSuriname({Key? key}) : super(key: key);

  @override
  State<DrawerSuriname> createState() => _DrawerSurinameState();
}
...
class _DrawerSurinameState extends State<DrawerSuriname> {
  @override
