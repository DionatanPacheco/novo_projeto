...
class DrawerChileCid extends StatefulWidget {
  const DrawerChileCid({Key? key}) : super(key: key);

  @override
  State<DrawerChileCid> createState() => _DrawerChileCidState();
}
...
class _DrawerChileCidState extends State<DrawerChileCid> {
  @override
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        style: const TextStyle(
                            fontSize: 25,
                            fontWeight: FontWeight.bold,
                            color: Color.fromARGB(221, 250, 247, 247)),
